...
export const djData: Record<string, DjInfo> = {
  dubvision: {
    ...
    imageUrl: '/images/dub_4.webp',
    logoImg: '/images/dub_logo.png',
    snsLink: [
      {
  ...
  matisseSadko: {
    ...
    imageUrl: '/images/ms_3.webp',
    logoImg: '/images/ms_logo.png',
    snsLink: [
      {
  ...
  thirdParty: {
    ...
    imageUrl: '/images/tp_3.webp',
    logoImg: '/images/tp_logo.png',
    snsLink: [
      {
  ...
  sickIndividuals: {
    ...
    imageUrl: '/images/si_3.webp',
    logoImg: '/images/sick_logo.png',
    snsLink: [
      {
